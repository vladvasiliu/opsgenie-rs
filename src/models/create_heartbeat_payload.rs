...
pub struct CreateHeartbeatPayload {
...
impl CreateHeartbeatPayload {
    pub fn new(name: String, interval: i32, interval_unit: IntervalUnit, enabled: bool) -> CreateHeartbeatPayload {
